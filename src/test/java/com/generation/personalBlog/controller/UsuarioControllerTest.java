...
public class UsuarioControllerTest {
    ...
    public void deveCriarUmUsuario() {
        HttpEntity<Usuario> corpoRequisicao = new HttpEntity<Usuario>(new Usuario(0L,
                "Vinicius E.", "viniciuse@email.com", "12345678", "-"));
    ...
    public void naoDeveDuplicarUsuario() {
        ...
        usuarioService.cadastrarUsuario(new Usuario(
                0L, "Maria Silva", "maria_silva@email.com", "123456", "-"));
    ...
    @Test
    @DisplayName("Deve atualiar usuario")
    public void deveAtualizarUsuario() {

        Optional<Usuario> usuarioCadastrado = usuarioService.cadastrarUsuario(new Usuario(
                0L, "Juliana Silva", "juliana_silva@email.com", "12345678", "-"));

        Usuario usuarioUpdate = new Usuario(usuarioCadastrado.get().getId(),
                "Juliana Silva Andrade", "juliana_silva_andrade@email.com", "12345678", "-");
